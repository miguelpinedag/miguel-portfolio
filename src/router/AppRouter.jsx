...
function AppRouter() {
  return (
    <Routes>
      ...
      <Route path="/proyectos/mapa-bogota" element={<MapaBogota />} />
      <Route path="/proyectos/dashboard-uno" element={<DashboardUno />} />
      <Route path="/proyectos/dashboard-dos" element={<DashboardDos />} />
      <Route
